...
/// <summary>
/// Wacsdk get links command for User.
/// </summary>
public class GetLinkCommand : Common.Links.GetLinkCommand
{
    ...
    public override async Task<IReadOnlyLinksCollection> GetEntityAsync(string repoId, string userId, CancellationToken cancellationToken)
    {
