...
/// <summary>
/// Wacsdk get publisher command.
/// </summary>
public class GetPublisherCommand : Command
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GetPublisherCommand"/> class.
    /// </summary>
    public GetPublisherCommand(WacsdkCommandConfig config, Option<string> repoOption, Option<string> idOption)
        : base("get", "Gets the publisher for the project.")
    {
    ...
    public async Task InvokeAsync(string repo, string id)
    {
        ...
        Logger.LogInformation($"Publisher: {publisher?.Id ?? "None"}");
    }
