...
/// <summary>
/// Wacsdk get entity extended description command.
/// </summary>
public abstract class GetEntityExtendedDescriptionCommand : Command
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GetEntityExtendedDescriptionCommand"/> class.
    /// </summary>
    public GetEntityExtendedDescriptionCommand(WacsdkCommandConfig config, string entityType, Option<string> repoOption, Option<string> idOption)
        : base("get", $"Gets the extended description for the {entityType}.")
    {
    ...
    public async Task InvokeAsync(string repo, string id)
    {
        ...
        Logger.LogInformation($"{nameof(entity.ExtendedDescription)}: {entity.ExtendedDescription}");
    }
