...
/// <summary>
/// Wacsdk add user role command for Publisher.
/// </summary>
public class AddUserRoleCommand : Common.UserRoles.AddUserRoleCommand
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AddUserRoleCommand"/> class.
    /// </summary>
    public AddUserRoleCommand(WacsdkCommandConfig config, Option<string> repoOption, Option<string> idOption, Option<string> userIdOption, Option<string> roleIdOption, Option<string> roleNameOption, Option<string> roleDescriptionOption)
        : base(config, "Publisher", repoOption, idOption, userIdOption, roleIdOption, roleNameOption, roleDescriptionOption)
    {
    }
