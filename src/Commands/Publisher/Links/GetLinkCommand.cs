...
/// <summary>
/// Wacsdk get links command for Publisher.
/// </summary>
public class GetLinkCommand : Common.Links.GetLinkCommand
{
    ...
    public override async Task<IReadOnlyLinksCollection> GetEntityAsync(string repoId, string publisherId, CancellationToken cancellationToken)
    {
