...
/// <summary>
/// Wacsdk entity images command for Publisher.
/// </summary>
public class EntityImagesCommand : Command
{
    ...
    /// </summary>
    public EntityImagesCommand(WacsdkCommandConfig config, Option<string> repoOption, Option<string> idOption, Option<string> imagePathOption, Option<string> requiredImageIdOption, Option<string?> optionalImageIdOption, Option<string?> imageNameOption)
        : base("images", "Manages the images of the Publisher.")
    {
